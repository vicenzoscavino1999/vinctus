  ...
  return (
    <div className="group border-b border-neutral-900 py-10 hover:bg-neutral-900/20 transition-colors -mx-6 px-6 md:px-0 md:mx-0">
      <div className="flex flex-col md:flex-row md:items-baseline mb-4">
        ...
        <span className="text-xs text-neutral-600 font-sans tracking-wider uppercase">
          {post.group}
        </span>
      </div>
      ...
      <div className="flex items-center justify-between mt-4">
        <div
          ...
          tabIndex={0}
          onKeyDown={(e) => {
            if (e.key === 'Enter') handleAuthorClick(e);
          }}
        >
          ...
          <span className="text-xs text-neutral-500 font-medium tracking-wide hover:text-white transition-colors">
            {post.author}
          </span>
