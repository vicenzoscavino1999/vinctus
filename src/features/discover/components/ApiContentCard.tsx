...
const ApiContentCard = ({ item, type }: ApiContentCardProps) => {
  ...
  const renderContent = () => {
    switch (type) {
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4 text-neutral-500 text-xs">
                <span className="flex items-center">
                  <Heart size={12} className="mr-1" /> {item.score}
                </span>
                <span className="flex items-center">
          ...
          <>
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                <span className="text-[10px] uppercase tracking-widest text-purple-400/80 block mb-1">
                  {item.type}
                </span>
        ...
        return (
          <>
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                <span className="text-[10px] uppercase tracking-widest text-amber-400/80 block mb-1">
                  {item.type}
                </span>
                <h3 className="text-lg text-neutral-200 font-serif font-light mb-2 group-hover:text-white transition-colors line-clamp-2">
                  {item.title}
          ...
          <>
            ...
            <div className="flex items-center justify-between text-neutral-500 text-xs">
              ...
              <div className="flex items-center gap-2">
                <span className="flex items-center">
                  <User size={12} className="mr-1" /> {item.observer}
                </span>
                <ExternalLink
                  size={14}
                  className="text-neutral-600 group-hover:text-white transition-colors"
      ...
      default:
        return <h3 className="text-lg text-neutral-200">{item.title}</h3>;
    }
  };
