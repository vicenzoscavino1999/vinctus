...
import { VoiceProvider, VoiceEvents, VoiceState, VoiceConfig, DEFAULT_VOICE_CONFIG } from './types';
...
export class WebSpeechProvider implements VoiceProvider {
  ...
  private speakChunks(chunks: string[]): void {
    ...
    const spanishVoice = voices.find(
      (v) => v.lang.startsWith('es-PE') || v.lang.startsWith('es-ES') || v.lang.startsWith('es'),
    );
    if (spanishVoice) {
