        ...
        <div className="max-w-2xl mx-auto pb-20 fade-in">
            ...
            {!user ? (
                ...
                <div className="space-y-8">
                    <section>
                        <h2 className="text-sm font-medium text-neutral-400 mb-4 uppercase tracking-wider px-2">Alertas principales</h2>
                    ...
                    <section>
                        ...
                        <div className="bg-[#1A1A1A] border border-neutral-800 rounded-2xl overflow-hidden">
                            ...
                            <ToggleRow
                                ...
                                onChange={() => handleUpdate({ ...settings, productUpdates: !settings.productUpdates })}
                                disabled={disabled}
                            />
                        </div>
                    </section>
