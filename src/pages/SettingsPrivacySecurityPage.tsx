...
const ToggleRow = ({ label, description, icon, checked, onChange, disabled }: ToggleRowProps) => (
    ...
    >
        ...
        <div className={`w-11 h-6 rounded-full border transition-colors ${checked ? 'bg-amber-500/80 border-amber-400' : 'bg-neutral-800 border-neutral-700'}`}>
            <div
        ...
        <div className="max-w-2xl mx-auto pb-20 fade-in">
            ...
            {!user ? (
                ...
                <div className="space-y-8">
                    <section>
                        <h2 className="text-sm font-medium text-neutral-400 mb-4 uppercase tracking-wider px-2">Privacidad</h2>
                        <div className="bg-[#1A1A1A] border border-neutral-800 rounded-2xl overflow-hidden">
                            <ToggleRow
                                ...
                                onChange={() => handleUpdate({
                                    ...settings,
                                    accountVisibility: settings.accountVisibility === 'private' ? 'public' : 'private'
                                })}
                                disabled={disabled}
                            />
                            <ToggleRow
                                ...
                                onChange={() => handleUpdate({ ...settings, allowDirectMessages: !settings.allowDirectMessages })}
                                disabled={disabled}
                            />
                            <ToggleRow
                                ...
                                onChange={() => handleUpdate({ ...settings, showOnlineStatus: !settings.showOnlineStatus })}
                                disabled={disabled}
                            />
                        </div>
                    </section>
                    ...
                    <section>
                        <h2 className="text-sm font-medium text-neutral-400 mb-4 uppercase tracking-wider px-2">Opcional</h2>
                        <div className="bg-[#1A1A1A] border border-neutral-800 rounded-2xl overflow-hidden">
                            <ToggleRow
                                ...
                                onChange={() => handleUpdate({ ...settings, showLastActive: !settings.showLastActive })}
                                disabled={disabled}
                            />
                            <ToggleRow
                                ...
                                onChange={() => handleUpdate({ ...settings, allowFriendRequests: !settings.allowFriendRequests })}
                                disabled={disabled}
                            />
                        </div>
                    </section>
                    ...
                    <section>
                        <h2 className="text-sm font-medium text-neutral-400 mb-4 uppercase tracking-wider px-2">Seguridad</h2>
                        <div className="bg-[#1A1A1A] border border-neutral-800 rounded-2xl overflow-hidden">
                            <ActionRow
