...
import { sendCollaborationRequest, type CollaborationRead } from '../lib/firestore';
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-neutral-500 mt-2">
                            Tu solicitud llegara como notificacion. La conversacion se habilita si el autor acepta.
                        </p>
                    </div>
