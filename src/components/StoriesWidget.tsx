...
import { getFriendIds, getStoriesForOwners, type StoryRead } from '../lib/firestore';
    ...
    return (
        <div className="w-full">
            ...
            <div className="flex gap-4 overflow-x-auto pb-2 -mx-4 px-4 scrollbar-hide">
                <div className="flex-shrink-0 flex flex-col items-center gap-2 text-center group">
                    <div className="relative">
                        ...
                        >
                            {user.photoURL ? (
                                <img src={user.photoURL} alt={user.displayName || 'Tu historia'} className="w-full h-full object-cover" />
                            ) : (
                    ...
                    friendGroups.map((group) => (
                        ...
                        >
                            <div className="w-16 h-16 rounded-full border-2 border-amber-400 bg-neutral-900 flex items-center justify-center overflow-hidden">
                                {group.ownerPhoto ? (
                                    <img src={group.ownerPhoto} alt={group.ownerName} className="w-full h-full object-cover" />
                                ) : (
            ...
            <StoryViewerModal
                ...
                onClose={() => setViewerState({ isOpen: false, ownerName: '', ownerPhoto: null, stories: [] })}
            />
        </div>
    );
};
