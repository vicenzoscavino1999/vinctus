...
import { createSupportTicket, type SupportTicketContext, type SupportTicketType } from '../lib/firestore';
                        ...
                        <div className="space-y-3">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder={type === 'issue' ? 'Ej: No puedo enviar mensajes' : 'Ej: Agregar modo compacto'}
                                />
                            </div>
